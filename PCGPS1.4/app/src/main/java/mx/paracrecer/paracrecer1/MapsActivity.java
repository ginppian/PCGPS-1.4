...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, LocationListener {
    ...
    int strokeColor = 0x116ED1; //blue outline
    ...
    */
    ...
    private void addListenerLocation() {
        ...
        Location first = mLocationManager.getLastKnownLocation(LocationManager.GPS_PROVIDER);

        actualizarUbicacionDBTiempoReal(first);
